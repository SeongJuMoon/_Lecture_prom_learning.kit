...
# 11. using browser enter the below query on 192.168.1.11/graph 
...
# retry enter below query on 192.168.1.11/graph 
redis_connect_clients 
# result 
redis_connect_clients  2

# 5. generate active memory pressure to redis.
...
# release trigger redis_benchmark for next step.
CTRL+C

# remove redis and redis-exporter
